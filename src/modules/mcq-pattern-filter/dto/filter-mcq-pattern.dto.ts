...
export class BaseFilterMcqPatternDto {
  @ApiProperty({
    description: 'Array of instruction medium IDs',
    required: true,
    type: [Number],
  })
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: 'Question origin type (board, other, both)',
    required: true,
    enum: QuestionOrigin,
  })
  @IsNotEmpty()
  @IsEnum(QuestionOrigin, {
    message: 'questionOrigin must be one of: board, other, both',
  })
  questionOrigin: QuestionOrigin;
}

// Used for /mcq-pattern-filter/unique-marks
export class FilterMcqPatternDto extends BaseFilterMcqPatternDto {}

// Used for /mcq-pattern-filter
export class FilterMcqPatternsWithMarksDto extends BaseFilterMcqPatternDto {
